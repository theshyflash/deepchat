...
// 定义左侧和右侧的选项
const leftOptions = ref(['中文', '英语', '日语']);
const rightOptions = ref(['中文', '英语', '日语']);
...
// 监听左侧选中的值
watch(leftSelect, (newValue) => {
  useLang.setLangFir(newValue);
});

// 监听右侧选中的值
watch(rightSelect, (newValue) => {
  useLang.setLangSecond(newValue);
});
</script>
